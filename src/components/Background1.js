...
const Background1 = ({ className = "" }) => {
  return (
    <section
      className={`self-stretch rounded-13xl bg-gray-400 overflow-hidden flex flex-col items-start justify-start pt-[152px] px-[211px] pb-[144.9px] box-border gap-[31.2px] max-w-full text-center text-61xl text-white font-bebas-neue mq450:pl-5 mq450:pr-5 mq450:box-border mq750:gap-4 mq750:pt-[99px] mq750:px-[105px] mq750:pb-[94px] mq750:box-border ${className}`}
    >
      ...
      <div className="self-stretch overflow-hidden flex flex-row items-start justify-between pt-0 px-0 pb-[0.1px] box-border max-w-full gap-5 z-[1] text-left text-lg-8 text-gray-1300 font-lexend mq1275:flex-wrap mq1275:justify-center">
